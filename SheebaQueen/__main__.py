...
from SheebaQueen.modules import ALL_MODULES
from SheebaQueen.modules.helper_funcs.chat_status import is_user_admin
from SheebaQueen.modules.helper_funcs.misc import paginate_modules
...
for module_name in ALL_MODULES:
    imported_module = importlib.import_module("SheebaQueen.modules." + module_name)
    ...
    if query.data == "Sheeba_":
        query.message.edit_text(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                 [
                    InlineKeyboardButton(text="Back", callback_data="Sheeba_back")
                 ]
                ]
            ),
        )
    elif query.data == "Sheeba_back":
        query.message.edit_text(
                PM_START_TEXT,
                reply_markup=InlineKeyboardMarkup(buttons),
                parse_mode=ParseMode.MARKDOWN,
